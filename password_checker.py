...
def check_password(another_passowrd = False):
    valid_password = False
    if another_passowrd:
        choice = input('Do you want to check another password\'s strength? (y/n) : ').lower()
    
    else:
        choice = input('Do you want to check your password\'s strength? (y/n):').lower()
